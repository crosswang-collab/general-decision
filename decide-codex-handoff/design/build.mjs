...
// 三段火力：同一個 app，換人就換氣壓。
const LEVELS = [
  { key: 'lv0', label: '菜鳥班長 阿良', rank: '菜鳥班長', name: '阿良', hello: '報、報告什麼事？班長…我是說，你各位啊。', sub: '',
  ...
  { key: 'lv1', label: '值星班長 黑面', rank: '值星班長', name: '黑面', hello: '你各位啊！報告什麼事？', sub: '合理的要求是訓練，不合理的要求是磨練。',
  ...
  { key: 'lv2', label: '士官長 老郭', rank: '士官長', name: '老郭', hello: '你各位給我站好。要報告什麼，三秒內講完。', sub: '我看過的菜鳥比你吃過的饅頭多。',
